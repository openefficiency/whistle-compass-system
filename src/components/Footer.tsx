          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link to="/support" className="hover:text-teal-400">Help Center</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link to="/admin-login" className="hover:text-teal-400">Admin Login</Link></li>
                <li><Link to="/investigator-login" className="hover:text-teal-400">Investigator Login</Link></li>
              </ul>
            </div>
          </div>
        </div>
